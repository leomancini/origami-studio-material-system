...
In Origami files that have an Android device selected, the components will appear under "Material > Other Components" in the layer insertion popover or the Patch Library.
